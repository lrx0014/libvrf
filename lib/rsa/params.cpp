...
RSAVRFParams get_rsavrf_params(vrf::Type type)
{
    ...
    case vrf::Type::RSASSA_FDH_VRF_RSA4096_SHA384:
    ...
    case vrf::Type::RSASSA_PSS_NOSALT_VRF_RSA2048_SHA256:
        return RSAVRFParams{RSAVRF_PARAMS(2048, "SHA256", RSA_PKCS1_PSS_PADDING, "\361RSASSA-PSS")};
    case vrf::Type::RSASSA_PSS_NOSALT_VRF_RSA3072_SHA256:
        return RSAVRFParams{RSAVRF_PARAMS(3072, "SHA256", RSA_PKCS1_PSS_PADDING, "\361RSASSA-PSS")};
    case vrf::Type::RSASSA_PSS_NOSALT_VRF_RSA4096_SHA384:
        return RSAVRFParams{RSAVRF_PARAMS(4096, "SHA384", RSA_PKCS1_PSS_PADDING, "\362RSASSA-PSS")};
    case vrf::Type::RSASSA_PSS_NOSALT_VRF_RSA8192_SHA512:
        return RSAVRFParams{RSAVRF_PARAMS(8192, "SHA512", RSA_PKCS1_PSS_PADDING, "\363RSASSA-PSS")};
    default:
        return RSAVRFParams{};
    }
}
